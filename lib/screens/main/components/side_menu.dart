      ...
      child: ListView(
        children: [
          ...
          DrawerListTile(
            ...
            press: () {
              context.mainScreenProvider.navigateToScreen('Areas');
            },
          ),
          DrawerListTile(
            title: "Brands",
          ...
          DrawerListTile(
            ...
            press: () {
              context.mainScreenProvider.navigateToScreen('Customer');
            },
          ),
          DrawerListTile(
            title: "Invoices",
            ...
            press: () {
              context.mainScreenProvider.navigateToScreen('Invoice');
            },
          ),
          DrawerListTile(
            title: "Sales Report",
            svgSrc: "assets/icons/menu_store.svg",
            press: () {
              context.mainScreenProvider.navigateToScreen('SalesReport');
            },
          ),
        //   DrawerListTile(
        //     title: "Variants",
